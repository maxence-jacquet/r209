 ...
 */
final class Version20250528084938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE vie_note (id INT AUTO_INCREMENT NOT NULL, createur_id INT NOT NULL, note_id INT NOT NULL, description VARCHAR(255) NOT NULL, update_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_1DB0ADB373A201E5 (createur_id), INDEX IDX_1DB0ADB326ED0855 (note_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
